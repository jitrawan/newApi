...
<script>
    if (!document.layers)
    document.write('<div id="divStayTopLeft" style="position:absolute;visibility:hidden;top:600;">')
</script>
<layer id="divStayTopLeft" style="visibility:hidden;">
