...
<tr>
    ...
    <td width="50%" class="PageTitleRight">
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <%if ((hasSave != null)&&(hasSave.equalsIgnoreCase("Y"))) {%>
                ...
                <td valign="middle" align="right">
                    <a href="javascript:save();" id="hasSaveOnhdr"><img border="0" alt="Save" src="<%=imgURL%>/btnSave.jpg"></a>
                </td>
                <td valign="middle" align="center"><img border="0" src="<%=imgURL%>/imgDivider.gif" height="20"></td>
            <%}%>
    ...
    <div style="float:right;margin:1px;text-align:right;text-align:right;">
        <span style="vertical-align:super;">&nbsp;&nbsp;:&nbsp;&nbsp;<font size="1" face="Verdana" color="#000000"><b>App Ver. </b>SMT_WEB_APP_BUILD_018_01_20170607</font></span>
    </div>
<%//End: Header Section%>
