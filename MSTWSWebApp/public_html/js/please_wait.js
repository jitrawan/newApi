...
if (/1\.(0|1|2)\.(0|1|2)/.test($.fn.jquery)) {
    jAlert('blockUI requires jQuery v1.2.3 or later!  You are using v' + $.fn.jquery);
    return;
}
...
function handleUnload() { 
	...
	self.topFrame.setLogout();
	//< bo dy on before Unload="handleUnload( )"> 
} 
function pausePage1(){
	...
	jQuery(function($) {
		...
		$.blockUI({ message: '<h4 class="pleaseWait"> Please wait ...</h4>' });
