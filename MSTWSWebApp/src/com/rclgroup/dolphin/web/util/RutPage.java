 ...
 public class RutPage {
     ...
     public RutPage(int maxItemsPerPage, int maxPagesPerPageSet, List items) {
        this(maxItemsPerPage,maxPagesPerPageSet,items,0,VERSION_01);
     }
     
     public RutPage() {
         this(MAX_ITEMS_PER_PAGE_DEFAULT,MAX_PAGES_DEFAULT,new ArrayList(),0,VERSION_01);
     }
     
    public RutPage(int maxItemPerPage,int maxPage) {
        this(maxItemPerPage,maxPage,new ArrayList(),0,VERSION_01);
    }
