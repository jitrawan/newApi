/*-----------------------------------------------------------------------------------------------------------  
RrcStandardHelpOptimizeUim.java
------------------------------------------------------------------------------------------------------------- 
...
public abstract class RrcStandardHelpOptimizeUim extends RrcStandardHelpUim {
    ...
    private RcmDefaultHelpDao rcmDefaultHelpDao;
    
    public RrcStandardHelpOptimizeUim() {
        this.titleName = "";
        this.titleNameShow = "";
        this.columnName = new Vector();
        this.columnNameShow = new HashMap();
        this.arrReturnValue = null;
        this.pageTarget = RcmConstant.MISC_PAGE_URL + "/RcmStandardHelpOptimizeScn.jsp";
        this.service = "";
        this.sqlStatement = "";
    ...
    //begin: function
    public void setRcmDefaultHelpDao(RcmDefaultHelpDao rcmDefaultHelpDao) {
        this.rcmDefaultHelpDao = rcmDefaultHelpDao;
    }
    ...
    public void createRutPage() {        
        ...
        int size = rcmDefaultHelpDao.findCountForHelpScreen(sqlForCount);
        
        String sqlForList = RutDatabase.optimizeSQL(sqlStatementForUse, rutPage.calculateRowAt(), rutPage.calculateRowTo());
        List list = rcmDefaultHelpDao.findListForHelpScreen(sqlForList, columnName, columnNameShow);
